	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord154 = input.ase_texcoord9.xy * _Tilling + float2( 0,0 );
				...
				float lerpResult168 = lerp( 1.0 , input.ase_color.r , _Ambient_Occlusion);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_Base_Color = input.ase_texcoord4.xy * _Base_Color_ST.xy + _Base_Color_ST.zw;
				float4 tex2DNode89 = tex2D( _Base_Color, uv_Base_Color );
				float2 texCoord154 = input.ase_texcoord4.xy * _Tilling + float2( 0,0 );
				float simplePerlin2D152 = snoise( texCoord154*_Tilling_Color );
				simplePerlin2D152 = simplePerlin2D152*0.5 + 0.5;
				float4 temp_output_163_0 = ( ( _Color * tex2DNode89 ) + ( _Color_Tilling * tex2DNode89 * simplePerlin2D152 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_Base_Color = input.ase_texcoord2.xy * _Base_Color_ST.xy + _Base_Color_ST.zw;
				float4 tex2DNode89 = tex2D( _Base_Color, uv_Base_Color );
				float2 texCoord154 = input.ase_texcoord2.xy * _Tilling + float2( 0,0 );
				float simplePerlin2D152 = snoise( texCoord154*_Tilling_Color );
				simplePerlin2D152 = simplePerlin2D152*0.5 + 0.5;
				float4 temp_output_163_0 = ( ( _Color * tex2DNode89 ) + ( _Color_Tilling * tex2DNode89 * simplePerlin2D152 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 uv_Base_Color = input.ase_texcoord.xy * _Base_Color_ST.xy + _Base_Color_ST.zw;
				float4 tex2DNode89 = tex2D( _Base_Color, uv_Base_Color );
...
ASEEND*/
//CHKSM=0994D4BE41A9EC4427C4B8B97CFDCDB84BEAAF3E